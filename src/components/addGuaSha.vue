      ...
      <div class="basic" id="addsDetail">
        ...
        <div class="block">
		  ...
		  <!-- <div class="jeinpbox" style="margin-left:0.05rem">
            <input type="text" v-model="i.BeginTime" class="jeinput startTime" placeholder="选择日期" readOnly='readOnly'>
          </div> -->
        </div>
        <div class="block">
          ...
          <el-date-picker
            ...
            size="small"
          ></el-date-picker>
		  <!-- <div class="jeinpbox" style="margin-left:0.2rem">
            <input type="text" v-model="i.EndTime" class="jeinput endTime" placeholder="选择日期" readOnly='readOnly'>
          </div> -->
        </div>
    ...
    <div class="add-item" v-for="(i , index)  in num" :key="index">
      ...
      <div class="basic" id="addsDetail">
        ...
        <div class="block">
          ...
          ></el-date-picker>
		  <!-- <div class="jeinpbox" style="margin-left:0.2rem">
            <input type="text" class="jeinput endTime" placeholder="选择日期" readOnly='readOnly'>
          </div> -->
        </div>
        <div style="border-bottom: none;">
          <div>班别</div>
...
export default {
  ...
  methods: {
      ...
      this.$confirm("确定删除此责任人吗？", "", {
        ...
        .then(() => {
          ...
          if (tag == "1") {
            ...
            this.startRadios[index + this.fuzeersLists.length] == ""
              ? ""
              : this.startRadios.splice(index + this.fuzeersLists.length, 1);
            this.endRadios[index + this.fuzeersLists.length] == ""
              ? ""
              : this.endRadios.splice(index + this.fuzeersLists.length, 1);
    ...
    confirms: function() {
      ...
      if (
		...
		//   emplisters.BeginTime = $(".startTime").eq(i).val();
        //   emplisters.EndTime = $(".endTime").eq(i).val();
        ...
        this.$axios({
          method: "post",
          url:  "/WarpingOrder/SaveWarYarnHung",
          data: {
            entity: entity,
            empjson: emplist
          }
  ...
  created() {
    ...
    if (this.$route.query.handle == "edit") {
      this.$axios({
        method: "post",
        url:  "/WarpingOrder/GetWarpYarnHungByID",
        data: {
